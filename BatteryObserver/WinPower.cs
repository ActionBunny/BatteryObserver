...
namespace BatteryObserver
{
    ...
    public class WinPower
    {
        ...
        public static PowerPolicies GetCurrentPowerPolicy()
        {
            ...
            if (!GetCurrentPowerPolicies(out globalPowerPolicy, out powerPolicy))
            {
                // An error occured while reading power options.
                var error = Marshal.GetLastWin32Error();
                throw new Win32Exception(error);
            }

            PowerPolicies powerPolicies = new PowerPolicies();
            powerPolicies.GlobalPowerPolicy = globalPowerPolicy;
            powerPolicies.PowerPolicy = powerPolicy;
            return powerPolicies;
        }

        [DllImport("powrprof.dll", SetLastError = true)]
        [return: MarshalAs(UnmanagedType.Bool)]
        private static extern bool GetCurrentPowerPolicies(out GLOBAL_POWER_POLICY pGlobalPowerPolicy, out POWER_POLICY pPowerPolicy);
    }
    ...
    public struct PowerPolicies
    {
        ...
        /// </summary>
        public GLOBAL_POWER_POLICY GlobalPowerPolicy
        {
            get;
            internal set;
        }
        ...
        /// </summary>
        public POWER_POLICY PowerPolicy
        {
            get;
            internal set;
        }
    ...
    /// <summary>
    /// Struct representing the global power policy (user spefific).
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
